...
export function renderExtraControls(state, onChange) {
    ...
    panel.innerHTML = `<div style="font-family:'Space Mono',monospace;font-size:0.55rem;color:#8899c8;letter-spacing:0.12em;margin-bottom:0.5rem;text-transform:uppercase">▸ Paramètres du signal</div>`;
